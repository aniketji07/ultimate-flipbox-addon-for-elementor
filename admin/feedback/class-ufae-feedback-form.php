...
if (! class_exists('UFAE_Feedback_Form')) {
	...
	class UFAE_Feedback_Form
	{
		...
		public function display_plugin_installed_form()
		{
			...
			echo '<div id="empty-field-msg"><p>' . __('!Please select a reason for your feedback before submitting the form.', 'ultimate-flipbox-addon-for-elementor') . '</p></div>';
			...
			echo '<label for="confirm">' . wp_kses_post(
				sprintf(
					__('By submitting, you agree to share your %1$s, %2$s, %3$s, and %4$s to help improve the plugin. Your data will remain private.', 'ultimate-flipbox-addon-for-elementor'),
					'<strong>' . esc_html__('Admin Email', 'ultimate-flipbox-addon-for-elementor') . '</strong>',
					'<strong>' . esc_html__('Site URL', 'ultimate-flipbox-addon-for-elementor') . '</strong>',
					'<strong>' . esc_html__('Plugin Version', 'ultimate-flipbox-addon-for-elementor') . '</strong>',
					'<strong>' . esc_html__('WP/PHP Versions', 'ultimate-flipbox-addon-for-elementor') . '</strong>'
				),
			...
			echo '<button type="submit" class="button button-feedback">' . __('Submit Feedback', 'ultimate-flipbox-addon-for-elementor') . '</button>';
