...
use UFAE\Widget\Post\Frontend\Ufae_Frontend_Output;
use UFAE\Admin\Controls\Ufae_Post_Control;

class UFAE_Post_Widget extends Widget_Base
{
	...
	public function __construct($data = array(), $args = null)
	{
		...
		wp_register_style('ufae-horizontal-style', UFAE_URL . 'assets/css/ufae-horizontal' . $ext . '.css', array('swiper'), UFAE_VERSION, 'all');
	...
	public function ufae_register_frontend_scripts()
	{
		...
		wp_register_script('ufae-horizontal-script', UFAE_URL . 'assets/js/ufae-horizontal' . $ext . '.js', array(), UFAE_VERSION, true);
	}
	...
	public function get_script_depends()
	{
		...
		$layout   = $settings['ufae_post_layout_option'];
	...
	{
		return 'ufae_post_flipbox_widget';
	}

	// Widget title
	public function get_title()
	{
		return __('Post Flipbox', 'ufae');
	}

	// Widget icon
	public function get_icon()
	{
		return 'eicon-flip-box'; // Choose appropriate Elementor icon
	}

	// Category for the widget in Elementor
	public function get_categories()
	{
		return ['ufae']; // You can change the category
	}
	...
	{
		return ['post', 'flipbox', 'ultimate', 'flip box', 'post flipbox', 'post flipbox widget'];
	}
	...
	protected function ufae_content_controls()
	{
		...
		$this->start_controls_section(
			'ufae_post_ufae_setting_section',
			[
				'label' => __('Post Settings', 'ufae'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);

		$this->add_group_control(
			Ufae_Post_Control::get_type(),
			[
				'name' => 'ufae_post',
				'label' => __('Post Type', 'ufae'),
				'fields_options' => [
					'post_type' => [
						'default' => 'post',
					]
		...
		$this->start_controls_section(
			'ufae_post_ufae_content_section',
			[
				'label' => __('Post Content', 'ufae'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);

		// Front/Back Tab Controls
		$this->start_controls_tabs('ufae_post_flipbox_content_setting');
		...
		$this->add_control(
			'ufae_post_front_title_enable',
			[
				'label' => __('Show Title', 'ufae'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'ufae'),
				'label_off' => __('Hide', 'ufae'),
				'default' => 'yes',
			]
		);

		$this->add_control(
			'ufae_post_front_desc_enable',
			[
				'label' => __('Show Description', 'ufae'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'ufae'),
				'label_off' => __('Hide', 'ufae'),
				'default' => 'no',
		...
		$this->add_control(
			'ufae_post_front_desc_length',
			[
				'label' => __('Description Length', 'ufae'),
				'type' => Controls_Manager::NUMBER,
				'default' => 10,
				'condition' => array(
					'ufae_post_front_desc_enable' => 'yes',
				),
			]
		);

		$this->add_control(
			'ufae_post_front_icon_enable',
			[
				'label' => __('Show Icon', 'ufae'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'ufae'),
				'label_off' => __('Hide', 'ufae'),
				'default' => 'yes',
		...
		$this->add_control(
			'ufae_post_front_icon_option',
			[
				'label' => __('Icon Option', 'ufae'),
				'type' => Controls_Manager::SELECT,
				'default' => 'custom_icon',
				'options' => [
					'custom_icon' => __('Custom Icon', 'ufae'),
					'feature_image' => __('Feature Image', 'ufae'),
				],
				'condition' => [
					'ufae_post_front_icon_enable' => 'yes',
				],
			]
		);

		$this->add_control(
			'ufae_post_front_custom_icon',
			[
				'label' => __('Select Custom Icon', 'ufae'),
				'type' => Controls_Manager::ICONS,
				'default' => [
					'value' => 'fas fa-clock', // Added default clock icon
					'library' => 'fa-solid', // Assuming Font Awesome solid library
				],
				'condition' => [
					'ufae_post_front_icon_enable' => 'yes',
					'ufae_post_front_icon_option' => 'custom_icon',
				],
			]
		);
		...
		$this->add_control(
			'ufae_post_back_desc_length',
			[
				'label' => __('Description Length', 'ufae'),
				'type' => Controls_Manager::NUMBER,
				'default' => 10,
				'condition' => array(
					'ufae_post_back_desc_enable' => 'yes',
				),
			]
		);
		...
		// Button Settings
		$this->add_control(
			'ufae_post_back_button_enable',
			[
				'label' => __('Enable Button', 'ufae'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'ufae'),
				'label_off' => __('Hide', 'ufae'),
				'default' => 'yes',
		...
		$this->add_control(
			'ufae_post_back_button_text',
			[
				'label' => __('Button Text', 'ufae'),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html('Read More', 'ufae')
			]
		);

		$this->add_control(
			'ufae_post_back_icon_enable',
			[
				'label' => __('Show Icon', 'ufae'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'ufae'),
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'ufae_post_back_icon_enable' => 'yes',
				],
			]
		);

		$this->add_control(
			'ufae_post_back_custom_icon',
			[
				'label' => __('Select Custom Icon', 'ufae'),
				'type' => Controls_Manager::ICONS,
				'default' => [
				...
				'condition' => [
					'ufae_post_back_icon_enable' => 'yes',
					'ufae_post_back_icon_option' => 'custom_icon',
				],
			]
		);
	...
	protected function ufae_content_layout_controls()
	{
		...
		$this->add_responsive_control(
			...
			array(
				...
				'condition' => array(
					'ufae_post_layout_option!' => 'horizontal',
				),
			)
		);

		$this->add_responsive_control(
			'ufae_post_hr_slider_perview_control',
			array(
		...
		$this->add_responsive_control(
			'ufae_post_horizontal_slides_gap',
			array(
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'ufae_post_animation_option' => 'flip',
				),
			)
		);

		$this->add_control(
			'ufae_post_flip_direction',
			array(
				...
				'default'   => 'left',
				'condition' => array(
					'ufae_post_animation_option' => array('flip', 'flip-classic', 'slide'),
				),
			)
		);

		$this->add_control(
			'ufae_post_transition_duration',
			array(
		...
		// $this->add_control(
		// 	'ufae_post_front_element_position',
		// 	array(
		...
		// $this->add_control(
		// 	'ufae_post_back_element_position',
		// 	array(
		// 		'label'       => esc_html__('Front Element Position', 'ultimate-flipbox-addon-for-elementor'),
		// 		'description' => esc_html__('Specify the order of flipbox elements as a comma-separated list (e.g., "icon, title, desc, button"). Ensure each element is separated by a comma.', 'ultimate-flipbox-addon-for-elementor'),
		// 		'type'        => \Elementor\Controls_Manager::TEXT,
	...
	protected function ufae_container_styles()
	{
		...
		$this->start_controls_section(
			'ufae_post_container_style_section',
			array(
		...
		$this->start_controls_tabs(
			'ufae_post_flipbox_container_style_tabs'
		);

		// container box front style tab - START
		$this->start_controls_tab(
			'ufae_post_front_container_tab',
			array(
		...
		$this->add_control(
			'ufae_post_container_front_bg_type',
			array(
		...
		$this->add_control(
			'ufae_post_container_front_bg_color',
			array(
				...
				'default'   => '#2F4F4F',
				'condition' => array(
					'ufae_post_container_front_bg_type' => 'simple',
				),
			)
		);

		$this->add_control(
			'ufae_post_container_front_bg_gradient_color_1',
			array(
				...
				'default' => '#9b51e0',
				'condition' => array(
					'ufae_post_container_front_bg_type' => 'gradient',
				),
			)
		);

		$this->add_control(
			'ufae_post_container_front_bg_gradient_color_2',
			array(
		...
		$this->add_control(
			'ufae_post_container_front_bg_gradient_direction',
			array(
		...
		$this->add_control(
			'ufae_post_container_front_bg_featured_image',
			[
				'label'        => esc_html__('Featured Image', 'ultimate-flipbox-addon-for-elementor'),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('On', 'ultimate-flipbox-addon-for-elementor'),
				'label_off'    => esc_html__('Off', 'ultimate-flipbox-addon-for-elementor'),
				'return_value' => 'yes',
				'default'      => 'yes',
				'selectors' => array(
					'{{WRAPPER}} ' . esc_html($this->common_selector) => '--ufae-box-front-bg-image: {{VALUE}}',
				),
				'condition' => [
					'ufae_post_container_front_bg_type' => 'image',
				],
			]
		);

		$this->add_control(
			'ufae_post_container_front_bg_image',
			[
				...
				'condition' => [
					'ufae_post_container_front_bg_type' => 'image',
					'ufae_post_container_front_bg_featured_image!' => 'yes',
				],
			]
		);

		$this->add_control(
			'ufae_post_container_front_bg_overlay', // Front overlay control
			array(
				...
				'default' => 'no',
				'condition' => [
					'ufae_post_container_front_bg_type' => 'image', // Only show if 'image' background type is selected
				],
			)
		);

		$this->add_control(
			'ufae_post_container_front_bg_overlay_color', // Front overlay color control
			array(
				...
				'condition' => [
					'ufae_post_container_front_bg_overlay' => 'yes', // Only show if overlay is enabled
					'ufae_post_container_front_bg_type' => 'image', // Only show if 'image' background type is selected
				],
			)
		);
		...
		$this->add_control(
			'ufae_post_container_front_border_popover',
			array(
		...
		$this->add_group_control(
			...
			array(
				...
				'condition' => array(
					'ufae_post_container_front_border_popover' => 'yes',
				),
			)
		);
		...
		$this->add_responsive_control(
			'ufae_post_front_items_alignment',
			array(
		...
		$this->add_responsive_control(
			'ufae_post_container_front_padding',
			array(
		...
		$this->add_control(
			'ufae_post_container_back_bg_type',
			array(
				'label'   => esc_html__('Background Type', 'twae'),
				'type'    => \Elementor\Controls_Manager::CHOOSE,
				'default' => 'simple',
		...
		$this->add_control(
			'ufae_post_container_back_bg_color',
			array(
				'label'     => esc_html__('Background Color', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
				...
				'default'   => '#4E5338',
				'condition' => array(
					'ufae_post_container_back_bg_type' => 'simple',
				),
			)
		);

		$this->add_control(
			'ufae_post_container_back_bg_gradient_color_1',
			array(
				'label'     => esc_html__('Gradient Color 1', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
				...
				'default' => '#f78da7',
				'condition' => array(
					'ufae_post_container_back_bg_type' => 'gradient',
				),
			)
		);

		$this->add_control(
			'ufae_post_container_back_bg_gradient_color_2',
			array(
				'label'     => esc_html__('Gradient Color 2', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'ufae_post_container_back_bg_gradient_direction',
			array(
				'label'     => esc_html__('Gradient Direction', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'to right',
		...
		$this->add_control(
			'ufae_post_container_back_bg_featured_image',
			[
				'label'        => esc_html__('Featured Image', 'ultimate-flipbox-addon-for-elementor'),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('On', 'ultimate-flipbox-addon-for-elementor'),
				...
				'default'      => 'yes',
				'selectors' => array(
					'{{WRAPPER}} ' . esc_html($this->common_selector) => '--ufae-box-back-bg-image: {{VALUE}}',
				),
				'condition' => [
					'ufae_post_container_back_bg_type' => 'image',
				],
			]
		);

		$this->add_control(
			'ufae_post_container_back_bg_image',
			[
				'label'     => esc_html__('Background Image', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::MEDIA,
				'selectors' => [
				...
				'condition' => [
					'ufae_post_container_back_bg_type' => 'image',
					'ufae_post_container_back_bg_featured_image!' => 'yes',
				],
			]
		);

		$this->add_control(
			'ufae_post_container_back_bg_overlay', // Back overlay control
			array(
				'label'   => esc_html__('Enable Overlay', 'twae'),
				'type'    => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'twae'),
				...
				'default' => 'no',
				'condition' => [
					'ufae_post_container_back_bg_type' => 'image', // Only show if 'image' background type is selected
				],
			)
		);

		$this->add_control(
			'ufae_post_container_back_bg_overlay_color', // Back overlay color control
			array(
				'label'     => esc_html__('Overlay Color', 'twae'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => 'rgba(0, 0, 0, 0.5)', // Default black semi-transparent overlay
				...
				'condition' => [
					'ufae_post_container_back_bg_overlay' => 'yes', // Only show if overlay is enabled
					'ufae_post_container_back_bg_type' => 'image', // Only show if 'image' background type is selected
				],
			)
		);
		...
		$this->add_responsive_control(
			'ufae_post_back_items_alignment',
			array(
				'label'     => esc_html__('Item Alignment', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::CHOOSE,
				'options'   => array(
		...
		$this->add_responsive_control(
			'ufae_post_container_back_padding',
			array(
		...
		$this->add_responsive_control(
			'ufae_post_container_border_radius',
			array(
		...
		$this->add_control(
			'ufae_post_container_boxshadow_popover',
			array(
				'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
		...
		$this->add_control(
			'ufae_post_container_box_shadow',
			array(
				'label'     => esc_html__('Box Shadow', 'ultimate-flipbox-addon-for-elementor'),
				...
				'condition' => array(
					'ufae_post_container_boxshadow_popover' => 'yes',
				),
			)
		);
	...
	protected function ufae_title_styles()
	{
		...
		$this->start_controls_tabs(
			'ufae_post_flipbox_title_style_tabs'
		);

		// title front style tab - START
		$this->start_controls_tab(
			'ufae_post_front_title_tab',
			array(
				'label' => esc_html__('Front', 'ultimate-flipbox-addon-for-elementor'),
				'condition' => array(
					'ufae_post_front_title_enable' => 'yes',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'      => 'ufae_post_title_front_typography',
		...
		$this->add_control(
			'ufae_post_title_front_bg_color',
			array(
				'label'     => esc_html__('Background Color', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'ufae_post_title_front_text_color',
			array(
		...
		$this->start_controls_tab(
			'ufae_post_back_title_tab',
			array(
				'label' => esc_html__('Back', 'ultimate-flipbox-addon-for-elementor'),
				'condition' => array(
					'ufae_post_back_title_enable' => 'yes',
				),
			)
		);
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			array(
				'name'      => 'ufae_post_title_back_typography',
		...
		$this->add_control(
			'ufae_post_title_back_text_color',
			array(
				'label'     => esc_html__('Text Color', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
	...
	protected function ufae_desc_styles()
	{
		...
		$this->start_controls_tabs(
			'ufae_post_flipbox_desc_style_tabs'
		);

		// desc front style tab - START
		$this->start_controls_tab(
			'ufae_post_front_desc_tab',
			array(
				'label' => esc_html__('Front', 'ultimate-flipbox-addon-for-elementor'),
				'condition' => array(
					'ufae_post_front_desc_enable' => 'yes',
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			array(
				'name'      => 'ufae_post_desc_front_typography',
		...
		$this->add_control(
			'ufae_post_desc_front_text_color',
			array(
				'label'     => esc_html__('Text Color', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'ufae_post_desc_back_text_color',
			array(
				'label'     => esc_html__('Text Color', 'ultimate-flipbox-addon-for-elementor'),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
	...
	protected function ufae_icon_styles()
	{
		...
		$this->start_controls_tabs(
			'ufae_post_flipbox_icon_style_tabs'
		);

		// icon front style tab - START
		$this->start_controls_tab(
			'ufae_post_front_icon_tab',
			array(
				'label' => esc_html__('Front', 'ultimate-flipbox-addon-for-elementor'),
				'condition' => array(
					'ufae_post_front_icon_enable' => 'yes',
		...
		$this->add_responsive_control(
			'ufae_post_icon_front_border_radius',
			array(
				'label'      => esc_html__('Border Radius', 'ultimate-flipbox-addon-for-elementor'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => array('px', '%', 'em'),
		...
		$this->add_responsive_control(
			'ufae_post_icon_back_border_radius',
			array(
				'label'      => esc_html__('Border Radius', 'ultimate-flipbox-addon-for-elementor'),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => array('px', '%', 'em'),
	...
	protected function ufae_btn_styles()
	{
		...
		$this->add_control(
			'ufae_post_btn_back_border_popover',
			array(
				'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
		...
		$this->add_group_control(
			...
			array(
				...
				'condition'      => array(
					'ufae_post_btn_back_border_popover' => 'yes',
					'ufae_post_back_button_enable'      => 'yes',
				),
			)
		);
	...
	protected function render()
	{
		...
		if (class_exists('UFAE\Widget\Post\Frontend\Ufae_Frontend_Output')) {
